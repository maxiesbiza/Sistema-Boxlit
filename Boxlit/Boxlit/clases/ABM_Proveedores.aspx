<%@ Page Title="" Language="C#" MasterPageFile="~/plantillas/PanelAdmin.Master" AutoEventWireup="true" CodeBehind="ABM_Proveedores.aspx.cs" Inherits="Boxlit.clases.ABM_Proveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="regionTitulo" runat="server"></asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="regionContenido" runat="server"></asp:Content>
